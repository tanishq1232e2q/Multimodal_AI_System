...
export default function Home() {
  ...
  { image: "/images/pexels-pixabay-208147.jpg", title: "Identify your mood" },
    ...
    <>
        ...
        <div className="hero">
          <div style={{textAlign: "center", marginTop: "2rem"}} className="hero-text">
            ...
            <div>
              ...
              <button className="btn2"><Link to="/dashboard">Get Started</Link></button>
      ...
      <div className="slides" >
        {slides.map((slide, index) => (
          <div
            key={index}
            className="group relative overflow-hidden rounded-lg shadow-md h-64 w-10 cursor-pointer"

          >
            <img
              src={slide.image}
              alt={slide.title} style={{ width: "30rem", height: "80%",borderRadius:"10px" }}
